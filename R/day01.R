...
#'
#' @param x some data
#' @return For Part One, `f01a(x)` returns the most calories carried by an Elf.
#'   For Part Two, `f01b(x)` returns the sum of the calories carried by the top
#'   three elves.
#' @export
#' @examples
